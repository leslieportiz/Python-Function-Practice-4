...
print("this is for max_num test:")
print(max_num(3,2,1))
print(max_num(100,150,200))
print(max_num(10,30,50))
...
print("this is for mult_list test:")
...
print("this is for rev_string test:")
print(rev_string(""))
...
print("this is for num_within test:")
...
print("this is for triangle test:")
pascal(2)
pascal(5)